    ...
    if ($img){
        if ($img->type == 'image'){
            if ($img->storage == 'public'){
                ...
                if ($full_size){
                    $url_path = \Illuminate\Support\Facades\Storage::disk('s3')->url('assets/uploads/images/'.$img->media_name);
                }else{
                    $url_path = \Illuminate\Support\Facades\Storage::disk('s3')->url('assets/uploads/images/thumbs/'.$img->media_name);
                }
